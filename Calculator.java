...
public class Calculator
{
    ...
    protected static int calculateTwoTokens(String[] tokens) throws NumberFormatException, CalculatorException
    {
        ...
        if(!command.equalsIgnoreCase("negate") && !command.equalsIgnoreCase("halve")) throw new CalculatorException("Illegal Command");
        else {
    ...
    protected static int execute(String[] tokens) throws NumberFormatException, CalculatorException
    {
        ...
        switch(tokens.length) {
        	...
        	case 1: if (tokens[0].equals("quit")) { return Integer.MIN_VALUE; }
        			else { throw new CalculatorException("Illegal Command"); }
